...
class Vue():
    def __init__(self,parent):
        ...
        self.canevas=Canvas(self.cadreapp,width=800,height=600, bg='#e8e8e7')
        self.canevas.create_text(400,300,anchor=CENTER,text='Module "Sous-traitance" est en construction \nPrévu pour la version 2.0 en automne 2021')
        self.canevas.pack()
        self.cadreapp.pack()
